...
Funcionalidade: Transferir valores entre contas
    ...
    Cenário: Transferir valores com sucesso entre contas
        Dada a conta "<origem>" com saldo <saldoOrigem> e a conta "<destino>" com saldo de <saldoDestino>
        Quando a conta "<origem>" transferir <valor> para a conta "<destino>"
        Então o saldo da conta "<origem>" deve ser <resultadoOrigem> e a conta "<destino>" deve estar com <resultadoDestino>
